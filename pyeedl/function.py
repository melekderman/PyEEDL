...
def float_endf(s: str) -> float:
    """Convert an ENDF 11‑char float field to Python float."""
...
def int_endf(s: str) -> int:
    """Convert ENDF 11‑char int field to Python int."""
    t = s.strip()
...
def parse_mf26_mt525(raw: str):
    """
    Parse MF=26, MT=525 data from line 9 onward of the ENDF block.
